...
class User {
   ...
   * 
   * NOTE: displayName will be the same as username when registering,
   *       so it wont be returned as it would be reduntant data
   **/
 ...
 /** Given a username, return data about user.
   *
   * Returns { username, display_name, email, is_admin, decks:[] }
 ...
 static async get(username) {
   ...
   *
   * Data can include:
   *   { displayName, password, email, isAdmin }
   *
